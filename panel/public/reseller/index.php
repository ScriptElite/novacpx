...
<meta name="description" content="NovaCPX 分销商控制面板 — 一站式管理您的主机分销账号、套餐、客户及品牌自定义设置。">
<meta name="keywords" content="主机分销面板, 分销控制台, 管理主机客户, 白标托管, NovaCPX 分销商">
<meta name="robots" content="noindex, nofollow">
<title><?= $_pname ?> — 分销商管理</title>
...
<div class="panel-layout" id="main-layout" style="display:none">
  <aside class="sidebar" id="sidebar">
    <div class="sidebar-brand">
      ...
      <span class="logo-text"><?= $_pname ?> <small style="font-size:.65rem;color:var(--text-muted)">分销商管理</small>
    ...
    <div class="sidebar-user">
      <div class="sidebar-user-info">
        ...
        <div><div class="user-name" id="user-name">分销商</div><div class="user-role">分销商账号</div></div>
...
<div id="auth-check" style="display:flex;align-items:center;justify-content:center;min-height:100vh;background:var(--bg)">
  <div style="width:100%;max-width:400px;padding:1.5rem">
    <div style="text-align:center;margin-bottom:1.5rem">
      ...
      <div style="font-size:.78rem;color:var(--text-muted);margin-top:.25rem;text-transform:uppercase;letter-spacing:.1em">分销商控制台</div>
    </div>
    <div class="card">
      <div class="card-body">
        ...
        <form id="login-form" onsubmit="event.preventDefault();doLogin()">
          ...
          <button type="submit" class="btn btn-primary btn-full">登录至分销商控制台</button>
        </form>
      </div>
    </div>
  </div>
