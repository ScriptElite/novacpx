...
<meta name="description" content="NovaCPX 管理员面板 — 功能完备的主机控制面板，用于管理服务器、账号、域名、邮箱、数据库及系统服务。">
<meta name="keywords" content="主机控制面板, 服务器管理, Web主机管理员, NovaCPX, 域名管理, 邮箱托管, 数据库管理">
<meta name="robots" content="noindex, nofollow">
<title>NovaCPX 管理员控制台</title>
...
<div class="sidebar-overlay" id="sidebar-overlay"></div>
  ...
  <aside class="sidebar" id="sidebar">
    <div class="sidebar-brand">
      ...
      <span class="logo-text">Nova<strong>CPX</strong> <small style="font-size:.65rem;color:var(--text-muted)">管理员</small>
    ...
    <nav>
      ...
      <div class="sidebar-section">
        <div class="sidebar-section-label">账号管理</div>
      ...
      <div class="sidebar-section">
        <div class="sidebar-section-label">DNS 解析</div>
      ...
      <div class="sidebar-section">
        <div class="sidebar-section-label">服务管理</div>
      ...
      <div class="sidebar-section">
        <div class="sidebar-section-label">安全防护</div>
      ...
      <div class="sidebar-section">
        ...
        <a href="#" class="sidebar-link" data-page="updates">
          ...
          系统更新 <span id="update-badge" class="badge badge-yellow" style="display:none"></span>
        </a>
    ...
    <div class="sidebar-user">
      <div class="sidebar-user-info">
        ...
        <div>
          ...
          <div class="user-role">系统超级管理员</div>
        </div>
        <a href="#" id="logout-btn" class="btn btn-ghost btn-sm btn-icon" title="退出登录" style="margin-left:auto">
  ...
  <div class="main-content">
    <header class="topbar">
      <button class="btn btn-ghost btn-icon" id="sidebar-toggle" aria-label="菜单"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" width="20" height="20"><line x1="3" y1="6" x2="21" y2="6"/><line x1="3" y1="12" x2="21" y2="12"/><line x1="3" y1="18" x2="21" y2="18"/></svg></button>

      <div class="topbar-title" id="page-title">仪表盘</div>
...
<div id="auth-check" style="display:flex;align-items:center;justify-content:center;min-height:100vh;background:var(--bg)">
  <div style="width:100%;max-width:400px;padding:1.5rem">
    <div style="text-align:center;margin-bottom:1.5rem">
      ...
      <div style="font-size:.78rem;color:var(--text-muted);margin-top:.25rem;text-transform:uppercase;letter-spacing:.1em">管理员控制台 · 端口 8882</div>
    </div>
    <div class="card">
      <div class="card-body">
        <div id="login-err" class="alert alert-error" style="display:none"></div>
        <form id="login-form">
          <div class="form-group"><label>用户名或邮箱</label><input type="text" id="l-user" autofocus required autocomplete="username"></div>
          <div class="form-group"><label>密码</label><input type="password" id="l-pass" required autocomplete="current-password"></div>
          <button type="submit" class="btn btn-primary btn-full" id="l-btn">登录至管理员控制台</button>
        </form>
      </div>
    </div>
  </div>
