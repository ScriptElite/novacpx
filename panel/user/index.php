...
<meta name="description" content="您的虚拟主机控制面板 — 一站式管理您的网站、域名、电子邮箱账户、数据库、FTP、SSL 证书及文件。">
<meta name="keywords" content="主机控制面板, 网站管理, 邮局托管, 域名管理, 数据库管理, SSL证书, FTP, Web主机仪表盘">
<meta name="robots" content="noindex, nofollow">
<title><?= $_pname ?> — 我的主机</title>
...
<div class="panel-layout" id="main-layout" style="display:none">
  <aside class="sidebar" id="sidebar">
    <div class="sidebar-brand">
      ...
      <span class="logo-text"><?= $_pname ?> <small style="font-size:.65rem;color:var(--text-muted)">我的主机</small>
    ...
    <div class="sidebar-user">
      <div class="sidebar-user-info">
        <div class="avatar" id="user-avatar">用</div>
        <div><div class="user-name" id="user-name">用户</div><div class="user-role" id="user-domain">example.com</div></div>
  ...
  <div class="main-content">
    <header class="topbar">
      ...
      <div class="topbar-title" id="page-title">我的主机</div>
...
<div id="auth-check" style="display:flex;align-items:center;justify-content:center;min-height:100vh;background:var(--bg)">
  <div style="width:100%;max-width:400px;padding:1.5rem">
    <div style="text-align:center;margin-bottom:1.5rem">
      ...
      <div style="font-size:.78rem;color:var(--text-muted);margin-top:.25rem;text-transform:uppercase;letter-spacing:.1em">我的主机</div>
    </div>
    <div class="card">
      <div class="card-body">
        <div id="li-err" class="alert alert-error" style="display:none"></div>
        <form id="login-form" onsubmit="event.preventDefault();doLogin()">
          <div class="form-group"><label>用户名或邮箱</label><input type="text" id="li-user" autofocus autocomplete="username"></div>
          <div class="form-group"><label>密码</label><input type="password" id="li-pass" autocomplete="current-password"></div>
...
<!-- user.js 通过 DOMContentLoaded 事件启动并处理所有认证与初始化逻辑 -->
</body>
</html>
