...
<meta name="description" content="NovaCPX 分销商面板 — 在一个仪表盘中统一管理您的分销主机账户、套餐、客户及品牌标识。">
<meta name="keywords" content="分销主机面板, 分销商控制面板, 管理主机客户, 白标主机, NovaCPX 分销商">
<meta name="robots" content="noindex, nofollow">
<title><?= $_pname ?> — 分销商</title>
...
<div class="panel-layout" id="main-layout" style="display:none">
  <aside class="sidebar" id="sidebar">
    <div class="sidebar-brand">
      ...
      <span class="logo-text"><?= $_pname ?> <small style="font-size:.65rem;color:var(--text-muted)">分销商</small>
    ...
    <div class="sidebar-user">
      <div class="sidebar-user-info">
        <div class="avatar" id="user-avatar">销</div>
        <div><div class="user-name" id="user-name">分销商</div><div class="user-role">分销商账户</div></div>
  ...
  <div class="main-content">
    <header class="topbar">
      ...
      <div class="topbar-title" id="page-title">分销商仪表盘</div>
    </header>
...
<div id="auth-check" style="display:flex;align-items:center;justify-content:center;min-height:100vh;background:var(--bg)">
  <div style="width:100%;max-width:400px;padding:1.5rem">
    <div style="text-align:center;margin-bottom:1.5rem">
      ...
      <div style="font-size:.78rem;color:var(--text-muted);margin-top:.25rem;text-transform:uppercase;letter-spacing:.1em">分销商面板</div>
    </div>
    <div class="card">
      <div class="card-body">
        ...
        <form id="login-form" onsubmit="event.preventDefault();doLogin()">
          ...
          <button type="submit" class="btn btn-primary btn-full">登录至分销商面板</button>
        </form>
      </div>
    </div>
  </div>
