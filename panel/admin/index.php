...
<meta name="description" content="NovaCPX 管理员面板 — 功能齐全的主机控制面板，用于管理服务器、账户、域名、电子邮件、数据库和各项服务。">
<meta name="keywords" content="主机控制面板, 服务器管理, Web主机管理, NovaCPX, 域名管理, 邮件托管, 数据库管理">
...
<div class="sidebar-overlay" id="sidebar-overlay"></div>
  ...
  <aside class="sidebar" id="sidebar">
    ...
    <nav>
      ...
      <div class="sidebar-section">
        <div class="sidebar-section-label">账户管理</div>
      ...
      <div class="sidebar-section">
        <div class="sidebar-section-label">服务组件</div>
...
<div id="auth-check" style="display:flex;align-items:center;justify-content:center;min-height:100vh;background:var(--bg)">
  <div style="width:100%;max-width:400px;padding:1.5rem">
    <div style="text-align:center;margin-bottom:1.5rem">
      ...
      <div style="font-size:.78rem;color:var(--text-muted);margin-top:.25rem;text-transform:uppercase;letter-spacing:.1em">管理员面板 · 端口 8882</div>
    </div>
    <div class="card">
      <div class="card-body">
        <div id="login-err" class="alert alert-error" style="display:none"></div>
        <form id="login-form">
          <div class="form-group"><label>用户名或电子邮箱</label><input type="text" id="l-user" autofocus required></div>
          <div class="form-group"><label>密码</label><input type="password" id="l-pass" required></div>
          <button type="submit" class="btn btn-primary btn-full" id="l-btn">登录到管理后台</button>
        </form>
      </div>
    </div>
  </div>
